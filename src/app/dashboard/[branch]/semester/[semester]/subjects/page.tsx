...
export default function SubjectsPage() {
  ...
  const fetchBranchAndSubjects = async (branchCode: string, semesterNumber: number) => {
    try {
      setIsLoading(true)
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500 mb-8">
          ...
          <ChevronRight className="w-4 h-4" />
          <span className="font-medium text-gray-900">Semester {semesterNumber}</span>
        </div>
        ...
        {filteredSubjects.length === 0 && searchTerm === '' && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600">This semester doesn't have any subjects configured yet.</p>
          </div>
        )}
                    ...
                    <CardContent className="p-6">
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                          ...
                          <Button
                            size="sm"
                            onClick={() => router.push(`/dashboard/${branchSlug}/semester/${semesterNumber}/subject/${subjectToSlug(subject.name)}`)}
